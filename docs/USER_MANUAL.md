...
截至 2026-06-24，`v0.4.25` 已完成 GitHub Release、双语 README、release zip smoke、install dry-run、本机 0.4.25 运行态加载和 native API 矩阵检查；当前仍有这些发布阻塞：
...
这些限制不影响使用 `v0.4.25` zip 作为公开预览版继续试用，但影响“发给别人当最终正式产品”的判断。
