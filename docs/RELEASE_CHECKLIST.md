...
- 插件名：Codex Companion
- 正式发布版本：0.4.54，对应 Git Tag `v0.4.54`
- MN4 插件 manifest 版本：0.4.54
- Companion 版本：0.4.54
- GitHub Release：https://github.com/LiuWhale/marginnote-assistant/releases/tag/v0.4.54
...
```bash
unzip CodexCompanion-0.4.54-latest-dist.zip
cd CodexCompanion-0.4.54
python3 release_smoke_test.py
python3 release_smoke_test.py --mnaddon ../CodexCompanion-0.4.54-latest.mnaddon
python3 release_smoke_test.py --mnaddon ../CodexCompanion-0.4.54-latest.mnaddon --install-dry-run
...
```bash
python3 notarize_pkg.py ./release/CodexCompanion-0.4.54-latest.pkg --keychain-profile "CodexNotary"
```
