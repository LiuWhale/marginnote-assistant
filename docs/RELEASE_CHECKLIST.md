...
```bash
unzip CodexCompanion-0.4.25-latest-dist.zip
cd CodexCompanion-0.4.25
...
```bash
python3 notarize_pkg.py ./release/CodexCompanion-0.4.25-latest.pkg --keychain-profile "CodexNotary"
```
