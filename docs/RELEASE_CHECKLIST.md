...
```bash
unzip CodexCompanion-0.4.22-latest-dist.zip
cd CodexCompanion-0.4.22
...
```bash
python3 notarize_pkg.py ./release/CodexCompanion-0.4.22-latest.pkg --keychain-profile "CodexNotary"
```
