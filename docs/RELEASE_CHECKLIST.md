...
- 插件名：Codex Companion
- 正式发布版本：0.4.55，对应 Git Tag `v0.4.55`
- MN4 插件 manifest 版本：0.4.55
- Companion 版本：0.4.55
- GitHub Release：https://github.com/LiuWhale/marginnote-assistant/releases/tag/v0.4.55
...
```bash
unzip CodexCompanion-0.4.55-latest-dist.zip
cd CodexCompanion-0.4.55
python3 release_smoke_test.py
python3 release_smoke_test.py --mnaddon ../CodexCompanion-0.4.55-latest.mnaddon
python3 release_smoke_test.py --mnaddon ../CodexCompanion-0.4.55-latest.mnaddon --install-dry-run
...
```bash
python3 notarize_pkg.py ./release/CodexCompanion-0.4.55-latest.pkg --keychain-profile "CodexNotary"
```
