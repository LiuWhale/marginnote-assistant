...
```bash
unzip CodexCompanion-0.4.42-latest-dist.zip
cd CodexCompanion-0.4.42
python3 release_smoke_test.py
python3 release_smoke_test.py --mnaddon ../CodexCompanion-0.4.42-latest.mnaddon
python3 release_smoke_test.py --mnaddon ../CodexCompanion-0.4.42-latest.mnaddon --install-dry-run
...
```bash
python3 notarize_pkg.py ./release/CodexCompanion-0.4.42-latest.pkg --keychain-profile "CodexNotary"
```
