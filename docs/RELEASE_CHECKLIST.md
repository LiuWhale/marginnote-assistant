...
```bash
unzip CodexCompanion-0.4.17-latest-dist.zip
cd CodexCompanion-0.4.17
...
```bash
python3 notarize_pkg.py ./release/CodexCompanion-0.4.17-latest.pkg --keychain-profile "CodexNotary"
```
