...
- 插件名：Codex Companion
- 当前发布候选：0.4.0 RC
- MN4 插件 manifest 版本：0.4.0
- Companion 版本：0.4.0 RC
...
```bash
unzip CodexCompanion-0.4.0-latest-dist.zip
cd CodexCompanion-0.4.0
...
```bash
python3 notarize_pkg.py ./release/CodexCompanion-0.4.0-latest.pkg --keychain-profile "CodexNotary"
```
