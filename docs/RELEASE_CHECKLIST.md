...
```bash
unzip CodexCompanion-0.4.16-latest-dist.zip
cd CodexCompanion-0.4.16
...
```bash
python3 notarize_pkg.py ./release/CodexCompanion-0.4.16-latest.pkg --keychain-profile "CodexNotary"
```
