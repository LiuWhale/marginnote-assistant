...
```bash
unzip CodexCompanion-0.4.29-latest-dist.zip
cd CodexCompanion-0.4.29
python3 release_smoke_test.py
python3 release_smoke_test.py --mnaddon ../CodexCompanion-0.4.29-latest.mnaddon
python3 release_smoke_test.py --mnaddon ../CodexCompanion-0.4.29-latest.mnaddon --install-dry-run
...
```bash
python3 notarize_pkg.py ./release/CodexCompanion-0.4.29-latest.pkg --keychain-profile "CodexNotary"
```
