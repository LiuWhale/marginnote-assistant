...
```bash
unzip CodexCompanion-0.4.15-latest-dist.zip
cd CodexCompanion-0.4.15
...
```bash
python3 notarize_pkg.py ./release/CodexCompanion-0.4.15-latest.pkg --keychain-profile "CodexNotary"
```
