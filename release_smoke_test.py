...
REQUIRED_SUFFIXES = [
    ...
    "companion/companion_url_security.py",
    "companion/send_action.py",
    "companion/refresh_mn_runtime.py",
    "companion/release_acceptance.py",
    "companion/doctor.py",
    "companion/verify_after_unlock.py",
...
MARKERS = {
    ...
    "companion/companion_url_security.py": "ACTION_TOKEN_HEADER",
    "companion/send_action.py": "from companion_url_security import",
    "companion/refresh_mn_runtime.py": "from companion_url_security import",
    "companion/release_acceptance.py": "from companion_url_security import",
    "companion/doctor.py": "from companion_url_security import",
    "companion/verify_after_unlock.py": "from companion_url_security import",
