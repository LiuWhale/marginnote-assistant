...
DEFAULT_PACKAGE_ZIP = ROOT / "release/CodexCompanion-0.4.17-latest-dist.zip"
DEFAULT_PACKAGE_PKG = ROOT / "release/CodexCompanion-0.4.17-latest.pkg"
    ...
    *,
    ...
    lines.extend(
        [
            ...
            "",
            "```bash",
            "python3 build_pkg.py release/CodexCompanion-0.4.17-latest-dist.zip --auto-sign --json",
            "python3 notarize_pkg.py release/CodexCompanion-0.4.17-latest.pkg --keychain-profile <profile> --json",
            "```",
            "",
        ]
    )
