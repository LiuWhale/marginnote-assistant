...
```bash
python3 package_release.py 0.4.2
```

Smoke-test the zip:

```bash
python3 release_smoke_test.py release/CodexCompanion-0.4.2-latest-dist.zip
python3 release_smoke_test.py release/CodexCompanion-0.4.2-latest-dist.zip --install-dry-run
```

Run the release acceptance report:

```bash
python3 release_acceptance.py release/CodexCompanion-0.4.2-latest-dist.zip --json
```
