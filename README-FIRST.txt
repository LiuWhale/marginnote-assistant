...
12. On a second macOS user or machine, collect install evidence:
   ...
   Or from Terminal, Run:
   python3 release_acceptance.py ./CodexCompanion-0.4.55-latest-dist.zip --collect-cross-machine-evidence ./cross-machine-evidence.json
...
14. Release maintainers can notarize and staple a signed pkg:
   Run: python3 notarize_pkg.py ./CodexCompanion-0.4.55-latest.pkg --keychain-profile "..."
