...
DEFAULT_ZIP = ROOT / "release/CodexCompanion-0.4.26-latest-dist.zip"
DEFAULT_OUTPUT = ROOT / "release/CodexCompanion-0.4.26-latest.pkg"
...
def main() -> int:
    ...
    parser.add_argument("--version", default="0.4.26", help="pkg version string.")
