...
DEFAULT_ZIP = ROOT / "release/CodexCompanion-0.4.3-latest-dist.zip"
DEFAULT_OUTPUT = ROOT / "release/CodexCompanion-0.4.3-latest.pkg"
...
def main() -> int:
    ...
    parser.add_argument("--version", default="0.4.3", help="pkg version string.")
