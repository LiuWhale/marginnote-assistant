...
DEFAULT_ZIP = ROOT / "release/CodexCompanion-0.4.9-latest-dist.zip"
DEFAULT_OUTPUT = ROOT / "release/CodexCompanion-0.4.9-latest.pkg"
...
def main() -> int:
    ...
    parser.add_argument("--version", default="0.4.9", help="pkg version string.")
