...
class RuntimeConfigTests(unittest.TestCase):
    def test_default_profile_is_codex_cli_gpt56_following_codex_config(self) -> None:
        ...
        self.assertIsNone(config.CODEX_CLI_TIMEOUTS["codex_config"])
        self.assertIsNone(config.CODEX_CLI_TIMEOUTS["priority"])
        self.assertIsNone(config.CODEX_CLI_LONG_TASK_TIMEOUT)
